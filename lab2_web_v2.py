...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 12 14:03:56 2017
...
workbook = xlrd.open_workbook('/Users/Alexandr/Downloads/1/lab2_web/lab2.xlsx')
#workbook = xlrd.open_workbook('/Users/Alexandr/Downloads/1/lab2_web/lab2_1.xlsx')
...
def write_dlt(dev1,dev2,dev3):
    ...
    for i in range(len(dev1)):
        ...
        ws.write(i, 2, dev3[i])
        i=i+1
    wb.save('/Users/Alexandr/Downloads/1/lab2_web/dlt.xls')
